defmodule GamesLobbyWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule GamesLobby.MyChannel do
        use GamesLobbyWeb, :channel
        alias GamesLobby.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :games_lobby,
                        pubsub_server: GamesLobby.PubSub
end
