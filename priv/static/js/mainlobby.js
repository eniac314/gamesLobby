				...
				return A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(_p18._0._0 + _p18._0._2),
								'px)'))));
			}
		};
		return _mdgriffith$stylish_elephants$Internal_Model$StyleClass(
			...
			function (_p25, group) {
				...
				return A3(
					...
					_p26._0,
					{
						...
						attrs: {ctor: '::', _0: _mdgriffith$stylish_elephants$Element$alignLeft, _1: _p26._1},
						width: 1,
						height: 1
					},
					group);
...
var _mdgriffith$stylish_elephants$Element_Input$checkbox = F2(
	function (attrs, _p27) {
		var _p28 = _p27;
		var _p35 = _p28.checked;
		var attributes = A2(
			_elm_lang$core$Basics_ops['++'],
			function () {
				var _p29 = _p28.onChange;
				if (_p29.ctor === 'Nothing') {
					return {
						ctor: '::',
						_0: _mdgriffith$stylish_elephants$Internal_Model$Attr(
								...
								_0: _mdgriffith$stylish_elephants$Element_Input$onKeyLookup(
									function (code) {
										return _elm_lang$core$Native_Utils.eq(code, _mdgriffith$stylish_elephants$Element_Input$enter) ? _elm_lang$core$Maybe$Just(
											_p30(!_p35)) : (_elm_lang$core$Native_Utils.eq(code, _mdgriffith$stylish_elephants$Element_Input$space) ? _elm_lang$core$Maybe$Just(
											_p30(!_p35)) : _elm_lang$core$Maybe$Nothing);
									}),
								_1: {ctor: '[]'}
							}
						}
		...
		var input = {
			...
			_2: {
				...
				_0: function () {
					var _p31 = _p28.icon;
					if (_p31.ctor === 'Nothing') {
						return _mdgriffith$stylish_elephants$Element_Input$defaultCheckbox(_p35);
					} else {
						return _p31._0;
					}
				}(),
			...
			function (group) {
				...
				return A3(
					...
					_p34,
					{
						...
						attrs: {ctor: '::', _0: _mdgriffith$stylish_elephants$Element$alignLeft, _1: _p32._1},
						width: function () {
							var _p33 = _p34;
							switch (_p33.ctor) {
								case 'Above':
...
var _mdgriffith$stylish_elephants$Element_Input$hasFocusStyle = function (attr) {
	var _p36 = attr;
	if (((_p36.ctor === 'StyleClass') && (_p36._0.ctor === 'PseudoSelector')) && (_p36._0._0.ctor === 'Focus')) {
		return true;
	} else {
		return false;
	}
...
var _mdgriffith$stylish_elephants$Element_Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var behavior = function () {
			...
			if (_p38.ctor === 'Nothing') {
				...
				return {
					ctor: '::',
					_0: _mdgriffith$stylish_elephants$Internal_Model$Attr(
						_elm_lang$html$Html_Events$onInput(_p38._0)),
					_1: {ctor: '[]'}
				};
			}
		}();
		...
		var noNearbys = A2(
			_elm_lang$core$List$filter,
			function (_p39) {
				return !forNearby(_p39);
			},
			attributes);
		var _p40 = function () {
			var _p41 = textInput.type_;
			if (_p41.ctor === 'TextInputNode') {
				return {
					ctor: '_Tuple3',
					_0: 'input',
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_1: {
								ctor: '::',
								_0: _mdgriffith$stylish_elephants$Internal_Model$Attr(
									_elm_lang$html$Html_Attributes$type_(_p41._0)),
								_1: {
									ctor: '::',
									...
									_1: {
										ctor: '::',
										_0: function () {
											var _p42 = textInput.autofill;
											if (_p42.ctor === 'Nothing') {
												return _mdgriffith$stylish_elephants$Internal_Model$NoAttribute;
											} else {
												return _mdgriffith$stylish_elephants$Element_Input$autofill(_p42._0);
											}
										}(),
										_1: {ctor: '[]'}
									}
				...
				var _p43 = A3(
					...
					F2(
						function (attr, _p44) {
							...
							do {
								switch (_p46.ctor) {
									case 'Describe':
										return {ctor: '_Tuple4', _0: _p54, _1: _p52, _2: _p55, _3: _p53};
									case 'Height':
										var _p49 = _p46._0;
										var _p47 = _p52;
										if (_p47.ctor === 'Nothing') {
											var _p48 = _p49;
											if (_p48.ctor === 'Content') {
												return {
													ctor: '_Tuple4',
													_0: _p54,
													_1: _elm_lang$core$Maybe$Just(_p49),
													_2: _p55,
													_3: {
														ctor: '::',
											...
											case 'PaddingStyle':
												...
												if (_p50.ctor === 'Nothing') {
													return {
														ctor: '_Tuple4',
														_0: _elm_lang$core$Maybe$Just(
															{ctor: '_Tuple4', _0: _p46._0._0, _1: _p46._0._1, _2: _p46._0._2, _3: _p46._0._3}),
														_1: _p52,
														_2: _p55,
														_3: {ctor: '::', _0: attr, _1: _p53}
													};
												} else {
													return {ctor: '_Tuple4', _0: _p54, _1: _p52, _2: _p55, _3: _p53};
												}
											case 'SpacingStyle':
												...
												if (_p51.ctor === 'Nothing') {
													return {
														...
														_0: _p54,
														_1: _p52,
														_2: _elm_lang$core$Maybe$Just(_p46._0._1),
														_3: {ctor: '::', _0: attr, _1: _p53}
													};
												} else {
													return {ctor: '_Tuple4', _0: _p54, _1: _p52, _2: _p55, _3: _p53};
					...
					attributes);
				var maybePadding = _p43._0;
				var heightContent = _p43._1;
				var maybeSpacing = _p43._2;
				var adjustedAttributes = _p43._3;
						...
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: function () {
										var _p56 = heightContent;
										if (_p56.ctor === 'Nothing') {
											return _mdgriffith$stylish_elephants$Internal_Model$NoAttribute;
										} else {
											if (_p56._0.ctor === 'Content') {
												...
												return _mdgriffith$stylish_elephants$Internal_Model$Height(_p56._0);
											}
										}
									}(),
									_1: {ctor: '[]'}
		...
		var inputNode = _p40._0;
		var inputAttrs = _p40._1;
		var inputChildren = _p40._2;
		var inputElement = {
			ctor: '_Tuple3',
		...
		var inputPadding = A2(
			...
			function (attr) {
				var _p59 = attr;
				if ((_p59.ctor === 'StyleClass') && (_p59._0.ctor === 'PaddingStyle')) {
					return true;
				} else {
					return false;
				}
		...
		return A3(
			...
			A2(
				...
				_elm_lang$core$Basics$identity,
				{
					ctor: '::',
					_0: function () {
						var _p60 = textOptions.label;
						return _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple3', _0: _p60._0, _1: _p60._1, _2: _p60._2});
					}(),
					_1: {
						ctor: '::',
						_0: function () {
							var _p61 = textOptions.placeholder;
							if (_p61.ctor === 'Nothing') {
								...
								if (_p62.ctor === '[]') {
									...
									return _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple3', _0: _mdgriffith$stylish_elephants$Internal_Grid$InFront, _1: _p62, _2: _mdgriffith$stylish_elephants$Internal_Model$Empty});
								}
							} else {
								return _elm_lang$core$Native_Utils.eq(
													...
													_1: {
														...
														_1: {
															...
															_1: A2(
																_elm_lang$core$Basics_ops['++'],
																inputPadding,
																A2(_elm_lang$core$Basics_ops['++'], nearbys, _p61._0._0))
														}
													}
												}
											}
											...
											_1: {
												...
												_1: function () {
													...
													if (_p65.ctor === 'Nothing') {
														...
														return {
															ctor: '::',
															_0: _mdgriffith$stylish_elephants$Element_Events$onClick(_p66),
															_1: {
																ctor: '::',
																_0: _mdgriffith$stylish_elephants$Element_Input$onEnter(_p66),
																_1: attrs
															}
														};
													}
...
var _mdgriffith$stylish_elephants$Element_Input$radioHelper = F3(
	function (orientation, attrs, input) {
				...
				A2(
					...
					function (attr) {
						...
						do {
							switch (_p69.ctor) {
								case 'StyleClass':
									if (_p69._0.ctor === 'Transparency') {
										return true;
									} else {
										break _v42_2;
									}
								case 'Class':
									if ((_p69._0 === 'hidden') && (_p69._1 === 'hidden')) {
										return true;
									} else {
										break _v42_2;
									}
		...
		var hideIfEverythingisInvisible = function () {
			if ((!labelVisible) && (!inputVisible)) {
				var pseudos = A3(
					...
					function (attr) {
						var _p71 = attr;
						if (_p71.ctor === 'StyleClass') {
							var _p72 = _p71._0;
							if (_p72.ctor === 'PseudoSelector') {
								var forTransparency = function (psuedoStyle) {
									var _p73 = psuedoStyle;
									if (_p73.ctor === 'Transparency') {
										return true;
									} else {
										return false;
									}
								};
								var transparent = A2(_elm_lang$core$List$filter, forTransparency, _p72._1);
								var _p74 = transparent;
								if (_p74.ctor === '[]') {
									return _elm_lang$core$Maybe$Nothing;
								} else {
									return _elm_lang$core$Maybe$Just(
										_mdgriffith$stylish_elephants$Internal_Model$StyleClass(
											A2(_mdgriffith$stylish_elephants$Internal_Model$PseudoSelector, _p72._0, transparent)));
								}
							} else {
								return _elm_lang$core$Maybe$Nothing;
							}
				...
				switch (_p78.ctor) {
					case 'NotFound':
						return _elm_lang$core$Native_Utils.eq(
							...
							input.selected) ? {ctor: '_Tuple3', _0: _mdgriffith$stylish_elephants$Element_Input$BeforeFound, _1: _p82, _2: _p81} : {ctor: '_Tuple3', _0: _p80, _1: _p79, _2: _p81};
					case 'BeforeFound':
						return {ctor: '_Tuple3', _0: _mdgriffith$stylish_elephants$Element_Input$AfterFound, _1: _p82, _2: _p79};
					default:
						return {ctor: '_Tuple3', _0: _p80, _1: _p82, _2: _p81};
				}
			});
		var prevNext = function () {
			var _p83 = input.options;
			if (_p83.ctor === '[]') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				var _p88 = _p83._0._0;
				return function (_p84) {
					...
					switch (_p86.ctor) {
						...
						default:
							return _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple2', _0: _p87, _1: _p85._2});
					}
				}(
					A3(
						_elm_lang$core$List$foldl,
						track,
						{ctor: '_Tuple3', _0: _mdgriffith$stylish_elephants$Element_Input$NotFound, _1: _p88, _2: _p88},
						input.options));
			}
		}();
		var toggleSelected = function () {
			var _p89 = input.selected;
		...
		var renderOption = function (_p90) {
			var _p91 = _p90;
			var _p95 = _p91._0;
			var status = _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Maybe$Just(_p95),
...
var _mdgriffith$stylish_elephants$Element_Input$select = F2(
	function (attrs, input) {
				...
				switch (_p106.ctor) {
					case 'NotFound':
						return _elm_lang$core$Native_Utils.eq(
							...
							_3: _p109
						} : {ctor: '_Tuple4', _0: _p108, _1: _p107, _2: _p111, _3: _p109};
					case 'BeforeFound':
						return {ctor: '_Tuple4', _0: _mdgriffith$stylish_elephants$Element_Input$AfterFound, _1: _p110, _2: _p111, _3: _p107};
					default:
						return {ctor: '_Tuple4', _0: _p108, _1: _p110, _2: _p111, _3: _p109};
				}
			});
		var prevNext = function () {
			var _p112 = input.menu;
			var _p120 = _p112._2;
			var _p113 = _p120;
			if (_p113.ctor === '[]') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				var _p119 = _p113._0._0;
				return function (_p114) {
					var _p115 = _p114;
					var _p118 = _p115._2;
					var _p117 = _p115._1;
					var _p116 = _p115._0;
					switch (_p116.ctor) {
						case 'NotFound':
							return _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple3', _0: _p117, _1: _p118, _2: _p119});
						case 'BeforeFound':
							return _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple3', _0: _p117, _1: _p118, _2: _p119});
						default:
							return _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple3', _0: _p117, _1: _p118, _2: _p115._3});
					}
				}(
					A3(
						_elm_lang$core$List$foldl,
						track,
						{ctor: '_Tuple4', _0: _mdgriffith$stylish_elephants$Element_Input$NotFound, _1: _p119, _2: _elm_lang$core$Maybe$Nothing, _3: _p119},
						_p120));
			}
		}();
		var toggleSelected = function () {
			var _p121 = input.selected.option;
		...
		var renderSelectedOption = function (_p122) {
			var _p123 = _p122;
			var status = _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Maybe$Just(_p123._0),
		...
		var renderOption = function (_p124) {
			var _p125 = _p124;
			var _p129 = _p125._0;
			var status = _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Maybe$Just(_p129),
				input.selected.option) ? _mdgriffith$stylish_elephants$Element_Input$Selected : _mdgriffith$stylish_elephants$Element_Input$Idle;
			return A2(
				_mdgriffith$stylish_elephants$Element$el,
				{
								...
								if (_p126.ctor === 'Nothing') {
									...
									return _mdgriffith$stylish_elephants$Element_Events$onClick(
										_p126._0(
											{
												menuOpen: false,
												option: _elm_lang$core$Maybe$Just(_p129)
											}));
								}
							}(),
							_1: {
		...
		var box = A2(
					...
					if (_p131.ctor === 'MenuAbove') {
						return _mdgriffith$stylish_elephants$Element$above(
							A2(
								...
								A2(_elm_lang$core$List$map, renderOption, _p133)));
					} else {
			...
			function () {
				...
				if (_p134.ctor === 'Nothing') {
					...
					var _p135 = _p134._0._1;
					if (_p135.ctor === 'Nothing') {
						var _p136 = input.placeholder;
						...
						return renderSelectedOption(_p135._0);
					}
				}
			}());
		var spacing = A2(
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {wsUrl: a, authToken: b, authSalt: c, phxSocket: d, playerInfo: e, log: f, errors: g, presences: h, chatMessageInput: i, chatLog: j, chatMessageBoxFocused: k, gamesMeta: l, gamesSetup: m, currentSelectedGame: n, waitingForOthers: o};
														};
													};
												};
											};
...
var _user$project$MainLobbyTypes$GameSetup = F5(
	function (a, b, c, d, e) {
		return {gameMeta: a, joined: b, hasStarted: c, host: d, gameId: e};
	});
...
var _user$project$MainLobbyTypes$Launch = function (a) {
...
var _user$project$MainLobbyView$gameSetupView = F2(
	function (model, _p3) {
		...
		if (_p5.ctor === 'Nothing') {
			...
			var hasJoinedGameSetup = A2(_elm_lang$core$List$member, model.playerInfo.username, _p8);
			var isGameSetupHost = _elm_lang$core$Native_Utils.eq(model.playerInfo.username, _p6);
			var gameTitle = A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Tuple$first(_p7).name,
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ',
					_elm_lang$core$Basics$toString(
					...
					_1: {
						...
						_0: A2(
							...
							_mdgriffith$stylish_elephants$Element$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Game hosted by: ', _p6))),
						_1: {
							ctor: '::',
							_0: A2(
								_mdgriffith$stylish_elephants$Element$column,
								...
								A2(_elm_lang$core$List$map, usrView, _p8)),
							_1: {
								ctor: '::',
								_0: isGameSetupHost ? A2(
									...
									},
									{
										onPress: _elm_lang$core$Maybe$Just(
											_user$project$MainLobbyTypes$DeleteGame(_p7)),
									...
									{
										onPress: _elm_lang$core$Maybe$Just(
											_user$project$MainLobbyTypes$JoinGame(_p7)),
									...
									{
										onPress: _elm_lang$core$Maybe$Just(
											_user$project$MainLobbyTypes$LeaveGame(_p7)),
								...
								_1: {
									...
									_0: (canStart && (!model.waitingForOthers)) ? A2(
										...
										{
											onPress: _elm_lang$core$Maybe$Just(
												_user$project$MainLobbyTypes$StartGame(_p7)),
...
var _user$project$MainLobbyView$gameMetaView = function (_p9) {
	var _p10 = _p9;
	return A2(
		_mdgriffith$stylish_elephants$Element$column,
		{
				...
				_1: {
					...
					_1: {
						...
						_0: _mdgriffith$stylish_elephants$Element_Events$onClick(
							_user$project$MainLobbyTypes$SelectGame(_p10)),
						_1: {
							ctor: '::',
							_0: _mdgriffith$stylish_elephants$Element$pointer,
							_1: {
		...
		},
		{
			...
			_0: A2(
				...
				_mdgriffith$stylish_elephants$Element$text(_p10.name)),
			_1: {
				ctor: '::',
				_0: A2(
					_mdgriffith$stylish_elephants$Element$el,
					...
					_mdgriffith$stylish_elephants$Element$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Min players: ',
							_elm_lang$core$Basics$toString(_p10.minPlayers)))),
				_1: {
					ctor: '::',
					_0: A2(
						_mdgriffith$stylish_elephants$Element$el,
						...
						_mdgriffith$stylish_elephants$Element$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'Max players: ',
								_elm_lang$core$Basics$toString(_p10.maxPlayers)))),
					_1: {
						ctor: '::',
						_0: A2(
							_mdgriffith$stylish_elephants$Element$el,
							...
							_mdgriffith$stylish_elephants$Element$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'Has AI: ',
									_elm_lang$core$Basics$toString(_p10.hasIA)))),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$MainLobbyView$gamesSetupView = function (model) {
	var _p11 = model.currentSelectedGame;
	if (_p11.ctor === 'Nothing') {
		var rows = A2(
			_elm_lang$core$List$map,
			function (r) {
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					_mdgriffith$stylish_elephants$Element$text(_p12.name)),
				_1: {
					ctor: '::',
					_0: A2(
						_mdgriffith$stylish_elephants$Element$row,
						...
						A2(
							...
							_elm_lang$core$Dict$values(
								A2(
									...
									F2(
										function (k, v) {
											return _elm_lang$core$Native_Utils.eq(v.gameMeta.name, _p12.name);
										}),
									model.gamesSetup)))),
					_1: {
						ctor: '::',
...
var _user$project$MainLobbyView$channelStatusView = F2(
	function (model, topic) {
		var _p13 = A2(_elm_lang$core$Dict$get, topic, model.phxSocket.channels);
				...
				},
				{
					...
					_0: _mdgriffith$stylish_elephants$Element$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Channel status: ',
							_elm_lang$core$Basics$toString(_p15.state))),
					_1: {
						ctor: '::',
						_0: controlButton,
						_1: {ctor: '[]'}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							_mdgriffith$stylish_elephants$Element$text(_p17.author.username)),
						_1: {
							ctor: '::',
							_0: A2(
								_mdgriffith$stylish_elephants$Element$el,
								...
								_mdgriffith$stylish_elephants$Element$text(
									_user$project$MainLobbyView$prettyDate(_p17.timeStamp))),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _mdgriffith$stylish_elephants$Element$text(_p17.message),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$MainLobby$init = function (flags) {
	...
	var newSocket1 = _p23._0;
	var phxCmd1 = _p23._1;
	var _p24 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, lobbyMainlobby, newSocket1);
	var newSocket2 = _p24._0;
	var phxCmd2 = _p24._1;
	var phxCmd = _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
